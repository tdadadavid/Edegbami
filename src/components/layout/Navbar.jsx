        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center">
              <Link to="/dashboard" className="px-3 py-2 text-sm font-medium text-white hover:bg-indigo-700 rounded-md">
                Dashboard
              </Link>
              <Link to="/courses" className="px-3 py-2 text-sm font-medium text-white hover:bg-indigo-700 rounded-md">
                Courses
              </Link>
              <Link to="/transcript" className="px-3 py-2 text-sm font-medium text-white hover:bg-indigo-700 rounded-md">
                Transcript
              </Link>
            </div>
          </div>
